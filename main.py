...
# =========================================================
# 🎨 TEMA FINTECH MODERNA (APENAS CSS - NÃO MUDA LÓGICA)
# =========================================================
st.markdown("""
<style>
/* ========================================================
   VARIÁVEIS DE CORES FINTECH
   ======================================================== */
:root {
    ...
    --sidebar-gradient: linear-gradient(195deg, #1a1a2e 0%, #16213e 100%);
...
section[data-testid="stSidebar"] .st-eb label {
...
section[data-testid="stSidebar"] .st-eb label:hover {
    background: rgba(255, 255, 255, 0.1);
    transform: translateX(5px);
}

section[data-testid="stSidebar"] .st-eb label[data-baseweb="radio"] div:first-child {
    background: rgba(255, 255, 255, 0.2) !important;
    border-color: rgba(255, 255, 255, 0.3) !important;
}

section[data-testid="stSidebar"] .st-eb label[data-baseweb="radio"] div:first-child div {
...
section[data-testid="stSidebar"] button[kind="secondary"] {
    ...
    box-shadow: 0 5px 15px rgba(255, 8, 68, 0.3) !important;
}

section[data-testid="stSidebar"] button[kind="secondary"]:hover {
    transform: translateY(-2px) !important;
    box-shadow: 0 8px 20px rgba(255, 8, 68, 0.4) !important;
}
...
/* Botões secundários (como em expanders) */
